...
void MenuDeCompra(float cred, int stockArray[], float mochila) {
    ...
    cout << "*  -------------------------------------------  * " << endl;
    cout << "* " << left << setw(18) << "1- Pao" << right << setw(13) << "$"<< precos[1] << right << setw(8) << stockArray[1] << "       *" << endl;
    cout << "* " << left << setw(18) << "2- Leite" << right << setw(10) << "$"<< precos[2] << right << setw(8) << stockArray[2] << "         *" << endl;
    cout << "* " << left << setw(18) << "3- Agua" << right << setw(13) << "$"<< precos[3] << right << setw(8) << stockArray[3] << "       *" << endl;
    cout << "* " << left << setw(18) << "4- Manteiga" << right << setw(14) << "$"<< precos[4] << right << setw(8) << stockArray[4] << "      *" << endl;
    cout << "* " << left << setw(18) << "5- Gelatina" << right << setw(9) << "$"<< precos[5] << right << setw(8) << stockArray[5] << "         *" << endl;
    cout << "* " << left << setw(18) << "6- Crepes" << right << setw(13) << "$" << precos[6]<< right << setw(8) << stockArray[6] << "       *" << endl;
    cout << "* " << left << setw(18) << "7- Pipocas" << right << setw(13) << "$"<< precos[7] << right << setw(8) << stockArray[7] << "       *" << endl;
    cout << "*                                               *" << endl;
    cout << "*************************************************" << endl;
...
void compra(int opc, float &cred, int stockArray[], float &mochila, int max, int min) {
    char decisao;
    int produtos;
    char trabalho;
    ...
    while (true) {
        ...
        if (produtos > mochila) {
            ...
            int ganhoEspaco = rand() % 3 + 1;
                mochila += ganhoEspaco;
                cout << "Ganhaste +" <<  ganhoEspaco << endl;
                cout << "Espaco na mochila restante" << endl;
            continue;
        }
...
int main() {
    ...
    while (true) {
        ...
        compra(opc, cred, stockArray, mochila, min, max);
    }
